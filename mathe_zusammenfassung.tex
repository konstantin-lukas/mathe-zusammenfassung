...
\section{Mengen}
	...
	\begin{multicols}{2}
		\begin{tcolorbox}[boxsep=0pt,top=.5cm,left=.5cm,right=.5cm, bottom=.5cm,arc=0pt,auto outer arc,colback=white,colframe=black, enlarge top by=.25cm]
			...
			\index{Natürliche Zahl}
			\begin{flalign*}
			\mathbb{N} = \{ 1; 2; 3; ... \}&&
			\end{flalign*}
		\end{tcolorbox}
		\begin{tcolorbox}[boxsep=0pt,top=.5cm,left=.5cm,right=.5cm, bottom=.5cm,arc=0pt,auto outer arc,colback=white,colframe=black, enlarge top by=.25cm]
			\textbf{Menge der Natürliche Zahlen}
			\index{Menge der natürlichen Zahlen}
			\begin{flalign*}
			\mathbb{N}_0 = \{ 0; 1; 2; 3; ... \}&&
			\end{flalign*}
		\end{tcolorbox}
...
\label{sec:rechengesetze}
	...
	\subsection{Intervalle}
		...
		\subsubsection{Abgeschlossene Intervalle}\index{Abgeschlossenes Intervall}
		$[a;b] := \{ x \in \mathbb{R} \mid a \le x \le b \}$
		\subsubsection{Offene Intervalle}\index{Offenes Intervall}
		$(a;b) = \: ]a;b[ \: := \{ x \in \mathbb{R} \mid a < x < b \}$
		\subsubsection{Halboffene Intervalle}\index{Halboffenes Intervall}
		Rechtsoffen\index{Rechtsoffen} \newline
	...
	\subsection{Wurzelgesetze}\index{Wurzelgesetz}
		...
		\subsubsection{Wurzeltherme vereinfachen (Beispiele)}\index{Vereinfachen}
			...
			\end{flalign*}
			\newline\newline\hrule
			Beispiel 3: Bestimmen Sie $x$ und $y$, sodass $\frac{x}{y}$ vollständig gekürzt\index{Gekürzt} ist.
			\begin{flalign*}
...
\section{Ungleichungen}
	...
	\section{Funktionen}
		...
		\label{subsubsec:newtonverfahren}
			Bei Polynomen\index{Polynom} 3. oder höheren gerade kann es passieren, dass man keine Nullstelle\index{Nullstelle} findet. Manchmal nicht einmal durch Raten. Die Funktion zu vereinfachen durch Polynomdivision\index{Polynomdivision} ist auch erst möglich, wenn man eine Nullstelle gefunden hat. In diesem hilft das Newtonverfahren\index{Newtonverfahren} sich einem Wert zu nähern. Hier ist ein Beispiel für so einen Fall.
