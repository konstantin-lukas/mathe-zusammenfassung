	...
	\section{Funktionen}
		...
		\subsection{Polynomfunktionen}
			\begin{tcolorbox}[boxsep=0pt,top=1cm,left=1cm,right=1cm, bottom=.85cm,arc=0pt,auto outer arc,colback=white,colframe=black, enlarge top by=.25cm, enlarge bottom by=.25cm]
				...
				\begin{center}
					...
					\end{axis}
					\node [color=blue] at (2.3,1.85) {$f(x)=x^4-x^3-2x^2$};
					\node [color=red] at (2.8,5) {$f(x)=x^4$};
					\node [color=teal] at (2.8,1) {$f(x)=-2x^2$};
					\end{tikzpicture}
				\end{center}
			\end{tcolorbox}
		\begin{center}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\addplot+[mark=none,color=blue] {x^4-5*x^2+2};
				\end{axis}
				\node [color=blue] at (12.5,1.3) {$p(x)=x^4-5x^2+2$};
			\end{tikzpicture}
		\end{center}
		\begin{flalign*}
			p(x)&=x^4-5x^2+2\\
		...
		\begin{center}
			...
			\addplot+[mark=none,color=blue] {x^5-3*x^3};
			\end{axis}
			\node [color=blue] at (11.75,1.3) {$p(x)=x^5-3x^3$};
			\end{tikzpicture}
		\end{center}
		\begin{flalign*}
		p(x)&=x^5-3x^3\\
		...
		\begin{center}
			...
			\addplot+[mark=none,color=blue] {x^4-2*x^2+1};
			\end{axis}
			\node [color=blue] at (11.6,3.2) {$p(x)=x^4-2x^2+1$};
			\end{tikzpicture}
		\end{center}
		\begin{flalign*}
		p(x)&=x^4-4x^2+1\\
		...
		\subsubsection{Lösen durch Polynomdivision}
			...
			\begin{center}
				...
				\addplot+[mark=none,color=blue] {2*x^3-5*x^2-2*x+5};
				\end{axis}
				\node [color=blue] at (3.9,3.2) {$p(x)=2x^3-5x^2-2x+5$};
				\end{tikzpicture}
			\end{center}
			\begin{flalign*}
			(2x^3-5x^2-2x+5):(x-1)&&
			...
			\begin{center}
				...
				\addplot+[mark=none,color=blue] {2*x^2-3*x-5};
				\end{axis}
				\node [color=blue] at (3.9,3.2) {$f(x)=2x^2-3x-5$};
				\end{tikzpicture}
			\end{center}
			\begin{flalign*}
				f(x)&=2x^2-3x-5\\
		...
		\subsection{Exponentialfunktionen}
			...
			\subsubsection{Lösen von Exponentialgleichungen}
				...
				\begin{center}
					...
					\addplot+[mark=none,color=blue] {(7^x)^(1/4)-4};
					\end{axis}
					\node [color=blue] at (10,3.2) {$f(x)=\sqrt[4]{7^x}-4$};
					\end{tikzpicture}
				\end{center}
				\begin{flalign*}
					f(x)&=\sqrt[4]{7^x}-4\\
		...
		\subsection{Logarithmusfunktionen}
			...
			\subsubsection{Lösen von Logarithmusgleichungen}
				...
				\begin{center}
					...
					\addplot+[mark=none,color=blue] {3*log10(x^3)-2*log10(x^2)-4};
					\end{axis}
					\node [color=blue] at (11,3.3) {$f(x)=3\cdot lg(x^3)-2\cdot lg(x^2)-4$};
					\end{tikzpicture}
				\end{center}
				\begin{flalign*}
