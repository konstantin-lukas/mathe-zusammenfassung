	...
	\subsection{Komplexe Zahlen}
		...
		\subsubsection{Polarform}
			...
			\subsubsection{Komplexe Zahlen potenzieren}
				Möchte man eine komplexe Zahl mit einer sehr hohen Zahl potenzieren, ist es ratsam, sie zunächst in die Exponentialdarstellung der Polarform zu bringen.
				\begin{flalign*}
					z^n=\left(r\cdot e^{i\phi}\right)^n=r^n\cdot e^{in\phi}\text{ wenn }n\in\mathbb{Z}&&
				\end{flalign*}
				Mithilfe der trigonometrischen Darstellung kann man ganz einfach den Real- und den Imaginärteil\index{Imaginärteil} bestimmen.
				\begin{flalign*}
				...
				\begin{tcolorbox}[boxsep=0pt,top=0.5cm,left=.5cm,right=.5cm, bottom=.5cm,arc=0pt,auto outer arc,colback=white,colframe=black, enlarge top by=0.25cm]
					...
					\begin{flalign*}
						(\cos(\phi)+i\cdot\sin(\phi))^n=\cos(n\cdot\phi)+i\cdot\sin(n\cdot\phi)\text{ wenn }n\in\mathbb{Z}&&
					\end{flalign*}
				\end{tcolorbox}
