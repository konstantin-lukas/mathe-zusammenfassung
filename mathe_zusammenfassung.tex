...
\section{Ungleichungen}
	...
	\subsection{Kurvendiskussion}
		...
		$f(x)=-\dfrac{x^{5}-12x^{4}+36x^{3}+25x^{2}-150x}{50}$
		\subsubsection{Symmetrie}
			...
			\textbf{Lösung:}\newline
			Diese ganzrationale Funktion kann weder gerade noch ungerade sein, da sie sowohl gerade, wie auch ungerade Exponenten enthält. Dennoch möchte ich es der Vollständig halber einmal rechnerisch belegen. Dafür überprüfen wir $f(-x)$. Sollte es mit $f(x)$ oder $-f(x)$ übereinstimmen, hätten wir Symmetrie.
			\begin{flalign*}
				f(-x)&=-\dfrac{(-x)^{5}-12\cdot (-x)^{4}+36\cdot (-x)^{3}+25\cdot (-x)^{2}-150\cdot (-x)}{50}\\
				&=-\dfrac{-x^{5}-12x^{4}-36x^{3}+25x^{2}+150x}{50}\\
				-f(x)&=-\left(-\dfrac{x^{5}-12x^{4}+36x^{3}+25x^{2}-150x}{50}\right)\\
				&=\dfrac{x^{5}-12x^{4}+36x^{3}+25x^{2}-150x}{50}\\
				f(-x)&\neq -f(x)\neq f(x)&&
			\end{flalign*}
		\subsubsection{Nullstellen}
			...
			\textbf{Lösung:}
			\begin{tcolorbox}[boxsep=0pt,top=0cm,left=0cm,right=7cm, bottom=.5cm,arc=0pt,auto outer arc,colback=white,colframe=white]
				\begin{flalign*}
					&&0&=-\frac{x^5-12x^4+35x^3+25x^2-150x}{50}\\
					\Leftrightarrow&&0&=\frac{-x^5+12x^4-35x^3-25x^2+150x}{50}\\
					\Leftrightarrow&&0&=\frac{1}{50}(-x^5+12x^4-35x^3-25x^2+150x)\\
					\Leftrightarrow&&0&=-\frac{1}{50}x^5+\frac{6}{25}x^4-\frac{18}{25}x^3-\frac{1}{2}x^2+3x\\
					\Leftrightarrow&&0&=x\left(-\frac{1}{50}x^4+\frac{6}{25}x^3-\frac{18}{25}x^2-\frac{1}{2}x+3\right)&&
				\end{flalign*}
			\end{tcolorbox}
			\noindent Eine Nullstelle haben wir dank Faktorisierung als $x=0$ bestimmt. Eine weitere Nullstelle können wir bestimmen, indem wir nur den zweiten Faktor betrachten. Durch Herumprobieren finden wir die Nullstelle $x=5$. Damit können wir jetzt eine Polynomdivision durchführen.\newline\newline
			\polylongdiv[style=C,div=:]{-(1/50)x^4+(6/25)x^3-(18/25)x^2-(1/2)x+3}{x-5}\newline\newline
			Durch weiteres Herumprobieren, finden wir jetzt auch die Nullstelle $x=6$. Damit können wir jetzt ein zweites Mal die Polynomdivision durchführen.\newline\newline
			\polylongdiv[style=C,div=:]{-(1/50)x^3+(7/50)x^2-(1/50)x-(3/5)}{x-6}\newline\newline
			Mit dem übrigen Polynom können wir jetzt die restlichen Nullstellen bestimmen.
			\begin{tcolorbox}[boxsep=0pt,top=0cm,left=0cm,right=7cm, bottom=.5cm,arc=0pt,auto outer arc,colback=white,colframe=white]
				\begin{flalign*}
						&&0&=-\frac{1}{50}x^2+\frac{1}{50}x+\frac{1}{10}&&\mid : -\frac{1}{50}\\
						\Leftrightarrow&&0&=x^2-x-5&&\mid \text{p-q-Formel}\\
						&&x_{1,2}&=\frac{1}{2}\pm\sqrt{\left(\frac{-1}{2}\right)^2+5}\\
						&&x_{1}&=\frac{1+\sqrt{21}}{2}\\
						&&x_{2}&=\frac{1-\sqrt{21}}{2}&&
				\end{flalign*}
			\end{tcolorbox}
			\noindent Da eine Polynomfunktion 5. Grades maximal 5 Nullstellen haben kann, können wir uns sicher sein, dass wir alle Nullstellen gefunden haben.
			\begin{flalign*}
				\mathbb{L}=\left\{\frac{1-\sqrt{21}}{2};0;\frac{1+\sqrt{21}}{2};5;6 \right\}
			\end{flalign*}
