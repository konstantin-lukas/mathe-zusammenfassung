...
\section{Substitution}
	...
	\end{flalign*}
	Diesen Term wiederum können wir ganz einfach mit der \textcolor{blue}{\nameref{subsec:pqformel}} lösen. Dabei erhalten wir $u_+=16$ und $u_-=-1$. Um unsere endgültige Lösungsmenge zu bekommen, müssen wir noch resubstituieren.
	\begin{flalign*}
	x^4&=u_+=16\\
	x_1&=2\\
	x_2&=-2&&
