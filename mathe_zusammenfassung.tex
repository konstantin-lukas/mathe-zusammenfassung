...
\section{Ungleichungen}
	...
	\section{Differenzialrechnung}
		...
		\label{subsec:ableitung}
			...
			\subsubsection{Eine Funktion und ihre Ableitungen}
	...
	\subsection{Tangentengleichung}
		...
		\begin{flalign*}
			...
			f^{\prime}(2)&=4&&
		\end{flalign*}
		Das können wir schon mal in unsere Gleichung einsetzen und erhalten $T(x)=4x+n$. Jetzt fehlt uns noch $n$, welches wir durch Umstellen bestimmen können, nachdem wir $x$ und $T(x)$ eingesetzt haben. Gesucht ist ja die Tangente an der Stelle $x=2$. Den $x$-Wert haben wir also schon mal und $T(x)$ können wir ganz einfach durch Einsetzen in die Funktion berechnen.
		\begin{flalign*}
			f(2)&=8\\
			f(2)&=4\cdot 2+n\\
			8&=4\cdot 2+n\\
	...
	\subsection{Rationalen Funktionen}
	\subsection{Grenzverhalten von ganzrationalen Funktionen}
