...
\section{Mengen}
	...
	\begin{tcolorbox}[boxsep=0pt,top=0cm,left=0cm,right=20cm, bottom=0cm,arc=0pt,auto outer arc,colback=white,colframe=white]
		\begin{flalign*}
			&\text{Anzahl der Elemente in einer Menge: }&\vert M\vert = x\\
	...
	\end{tcolorbox}
	 ...
	 Das Komplement\index{Komplement} einer Menge $M$ in einem Universum $U$ enthält alle Elemente, die nicht in $M$ sind, aber im Universum $U$ existieren. Sind das Universum z.~B. die natürlichen Zahlen, so gilt: $M^C=\bar M=\mathbb{N}\setminus M$.
