...
\newcommand{\foo}[1]{
	\begin{center}
		...
		\addplot+[mark=none, color=\tempc] {\tempa};
		\end{axis}
		\node [color=\tempc] at (\tempd) {\tempb};
		\end{tikzpicture}
	\end{center}
}
\newcommand\fullwidthplots[9]{
	\def\tempa{#1}
	\def\tempb{#2}
	\def\tempc{#3}
	\def\tempd{#4}
...
\newcommand{\fooo}[5]{
	\begin{center}
		...
		\addplot+[mark=none, color=\tempc] {\tempa};
		\addplot+[mark=none, color=\tempg] {\tempe};
		\end{axis}
		\node [color=\tempc] at (\tempd) {\tempb};
		\node [color=\tempg] at (\temph) {\tempf};
		\end{tikzpicture}
	\end{center}
}
\begin{document}
...
\section{Elementare Rechengesetze, -verfahren und -notationen}
	...
	\subsection{Lösungsmenge}
		...
		\fullwidthplot{5-x^2}{$f(x)=5-x^2$}{blue}{11,3.3}{-10}{10}{-10}{10}{330}{-30:30}
...
\section{Ungleichungen}
	...
	\subsection{Quadratische Ungleichungen}
		...
		\fullwidthplot{x^2-2*x-7}{$f(x)=x^2-2x-7$}{blue}{5,1}{-10}{10}{-10}{10}{330}{-30:30}
	...
	\subsection{Ungleichungen mit Beträgen}
		...
		\fullwidthplot{abs(x)-3}{$f(x)=\vert x \vert -3$}{blue}{5,1.75}{-10}{10}{-10}{10}{330}{-30:30}
	...
	\subsection{Ungleichungen mit Variable im Nenner – Teil I}
		...
		\fullwidthplot{(14/abs(2*x+5))-2}{$f(x)=\dfrac{14}{\vert 2x+5\vert}-2$}{blue}{10,2}{-10}{10}{-2}{10}{200}{-30:30}
	...
	\subsection{Ungleichungen mit Variable im Nenner – Teil II}
		...
		\fullwidthplot{(1/(x-2))+x}{$f(x)=\frac{1}{x-2}+x$}{blue}{11,1}{-10}{10}{-10}{10}{350}{-20:20}
		...
		\fullwidthplot{(1/(x-9))-8}{$f(x)=\frac{1}{x-9}-8$}{blue}{11,1.5}{-2}{16}{-20}{5}{330}{-30:60}
		Fall 1: $x>9$
		\begin{flalign*}
			\frac{1}{x-9}&\le 8\\
			1&\le 8x-72\\
	...
	\section{Funktionen}
		...
		\subsection{Potenz- und Wurzelfunktionen}
			...
			\fullwidthplots{sqrt(abs(2*x+1))}{$f(x)=\sqrt{2x+1}$}{blue}{6.5,3.6}{x-17}{$f(x)=x-17$}{red}{8.3,1.4}{0}{30}{0}{10}{600}{-60:60}
		...
		\subsection{Betragsfunktionen}
			...
			\fullwidthplots{x+2}{$f(x)=x+2$}{blue}{5.5,4}{abs(x+1)}{$f(x)=\vert x+1\vert$}{red}{9.5,3.2}{-5}{5}{-4}{4}{100}{-10:10}
			...
			\fullwidthplots{abs(x+1)+5}{$f(x)=\vert x+1 \vert + 5$}{blue}{6.9,3.6}{abs(2*x-4)}{$f(x)=\vert 2x-4 \vert$}{red}{10,1.7}{-4}{14}{0}{20}{300}{0:20}
		...
		\subsection{Polynomfunktionen}
			\begin{tcolorbox}[boxsep=0pt,top=1cm,left=1cm,right=1cm, bottom=.85cm,arc=0pt,auto outer arc,colback=white,colframe=black, enlarge top by=.25cm, enlarge bottom by=.25cm]
				...
				\begin{center}
					...
					\addplot+[mark=none,color=blue] {x^4-x^3-2*x^2};
					\addplot+[mark=none,color=red] {x^4};
					\addplot+[mark=none,color=teal] {-2*x^2};
					\end{axis}
					\node [color=blue] at (5,3.2) {$f(x)=x^4-x^3-2x^2$};
					\node [color=red] at (5.7,5) {$f(x)=x^4$};
					\node [color=teal] at (5.9,1) {$f(x)=-2x^2$};
					\end{tikzpicture}
				\end{center}
			\end{tcolorbox}
		\begin{center}
			...
			\addplot+[mark=none,color=blue] {4*x^6+x^4-3*x^2+2};
			\end{axis}
			\node [color=blue] at (3.78,3.2) {$f(x)=4x^6+x^4-3x^2+2$};
			\end{tikzpicture}
			\hspace{1cm}
			\begin{tikzpicture}
			\begin{axis}[
			...
			\addplot+[mark=none,color=red] {3*x^5+2*x^4-3*x^3+1};
			\end{axis}
			\node [color=red] at (5,2.15) {$f(x)=3x^5+2x^4-3x^3+1$};
			\end{tikzpicture}\newline\newline\newline
			\begin{tcolorbox}[boxsep=0pt, left=2.2cm, top=0cm, bottom=0cm,right=0cm,arc=0pt,auto outer arc,colback=white,colframe=white]
				\begin{center}
					\begin{tikzpicture}
					\begin{axis}[
					domain=-5:5,
					...
					\addplot+[mark=none,color=teal] {x^5+2*x^4-3*x^3-3*x^2+4*x};
					\end{axis}
					\node [color=teal] at (7,1) {$f(x)=x^5+2x^4-3x^3-3x^2+4x$};
					\end{tikzpicture}
				\end{center}
			\end{tcolorbox}
		\end{center}
		...
		\fullwidthplot{x^4-5*x^2+2}{$p(x)=x^4-5x^2+2$}{blue}{12.5,1.3}{-6}{6}{-6}{6}{300}{-30:60}
		\begin{flalign*}
			p(x)&=x^4-5x^2+2\\
			0&=x^4-5x^2+2\\
			0&=u^2-5u+2\\
		...
		\fullwidthplot{x^5-3*x^3}{$p(x)=x^5-3x^3$}{blue}{11.75,1.3}{-6}{6}{-6}{6}{300}{-30:60}
		\begin{flalign*}
		p(x)&=x^5-3x^3\\
		0&=x^5-3x^3\\
		0&=x^2(x^2-3)\\
		...
		\fullwidthplot{x^4-2*x^2+1}{$p(x)=x^4-2x^2+1$}{blue}{11.6,3.2}{-6}{6}{-6}{6}{300}{-30:60}
		\begin{flalign*}
		p(x)&=x^4-4x^2+1\\
		0&=x^4-4x^2+1\\
		0&=(x^2-1)^2\\
		...
		\subsubsection{Lösen durch Polynomdivision}
			...
			\fullwidthplot{2*x^3-5*x^2-2*x+5}{$p(x)=2x^3-5x^2-2x+5$}{blue}{3.9,3.2}{-6}{6}{-6}{6}{300}{-30:60}
			\begin{flalign*}
			(2x^3-5x^2-2x+5):(x-1)&&
			\end{flalign*}
			...
			\fullwidthplot{2*x^2-3*x-5}{$f(x)=2x^2-3x-5$}{blue}{3.9,3.2}{-6}{6}{-10}{10}{300}{-30:60}
			\begin{flalign*}
				f(x)&=2x^2-3x-5\\
				0&=2x^2-3x-5\\
				0&=x^2-1,5x-2,5\\
		...
		\subsection{Exponentialfunktionen}
			...
			\begin{center}
				...
				\addplot+[mark=none,color=blue] {e^x};
				\end{axis}
				\node [color=blue] at (4.9,3.3) {$f(x)=e^x$};
				\end{tikzpicture}
				\hspace{1cm}
				\begin{tikzpicture}
				\begin{axis}[
				...
				\addplot+[mark=none,color=red] {e^(-x)};
				\end{axis}
				\node [color=red] at (2,3.3) {$f(x)=e^{-x}$};
				\end{tikzpicture}
			\end{center}
			\subsubsection{Lösen von Exponentialgleichungen}
				...
				\fullwidthplot{(7^x)^(1/4)-4}{$f(x)=\sqrt[4]{7^x}-4$}{blue}{10,3.2}{-6}{6}{-10}{10}{300}{-30:60}
				\begin{flalign*}
					f(x)&=\sqrt[4]{7^x}-4\\
		...
		\subsection{Logarithmusfunktionen}
			...
			\begin{center}
				...
				\addplot+[mark=none,color=blue] {ln(x)};
				\end{axis}
				\node [color=blue] at (4.9,4.3) {$f(x)=ln(x)$};
				\end{tikzpicture}
				\hspace{1cm}
				\begin{tikzpicture}
				\begin{axis}[
				...
				\addplot+[mark=none,color=red] {log10(x)};
				\end{axis}
				\node [color=red] at (2,3.3) {$f(x)=lg(x)$};
				\end{tikzpicture}
				\newline\newline\newline
				\begin{tikzpicture}
				\begin{axis}[
				...
				\addplot+[mark=none,color=teal] {-ln(abs(x))};
				\end{axis}
				\node [color=teal] at (5.1,1.3) {$f(x)=-ln(\vert x\vert)$};
				\end{tikzpicture}
				\hspace{1cm}
				\begin{tikzpicture}
				\begin{axis}[
